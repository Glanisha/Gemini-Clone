  ...
  return (
    <div className='m-10 w-full h-full font-outfit flex flex-col'>
      ...
      <div className='flex justify-between items-center'>
        ...
        <img src={assets.user_icon} alt="User Icon" className='w-12 h-12 rounded-full' />
      </div>
      ...
      <div className='mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8'>
        <Card text="Suggest beautiful places to see during my next road trip." img={assets.compass_icon} />
        <Card text="Suggest beautiful places to see during my next road trip." img={assets.compass_icon} />
        <Card text="Suggest beautiful places to see during my next road trip." img={assets.compass_icon} />
      </div>
      ...
      <div className='mt-10 flex items-center space-x-4'>
        ...
        />
        <img src={assets.gallery_icon} alt="Gallery Icon" className='w-8 h-8 cursor-pointer' />
        <img src={assets.mic_icon} alt="Mic Icon" className='w-8 h-8 cursor-pointer' />
        <img src={assets.send_icon} alt="Send Icon" className='w-8 h-8 cursor-pointer' />
      </div>
    </div>
  )
}
